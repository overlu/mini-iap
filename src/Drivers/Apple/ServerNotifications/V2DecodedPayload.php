...
namespace MiniIap\Drivers\Apple\ServerNotifications;

use MiniIap\Drivers\Apple\Jws\JsonWebSignature;
use MiniIap\Drivers\Apple\Jws\Parser;
use MiniIap\Drivers\Apple\ValueObjects\AppMetadata;
use MiniIap\Drivers\Apple\ValueObjects\JwsRenewalInfo;
use MiniIap\Drivers\Apple\ValueObjects\JwsTransactionInfo;
use MiniIap\Drivers\Apple\ValueObjects\Time;
...
final class V2DecodedPayload implements Arrayable
{
    ...
    {
        return (new Time($this->rawData['signedDate']))->toDateTimeString();
    }
